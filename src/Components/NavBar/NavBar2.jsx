    ...
    <Box style={{ position: 'fixed', top: 0, width: '100%', zIndex: 999 }}>
      <Box style={{ display: 'flex', justifyContent: 'center', alignItems: 'center', padding: '15px' }}>
        ...
        >
          <Box>
            <Typography
              style={{ fontSize: '14px', fontWeight: 'bold', fontFamily: 'Roboto,sans-serif', color: '#fff', cursor: 'pointer' }}
              onClick={() => handleClick('/')}
            >
              SankyFy.com
            </Typography>
          ...
          <Box style={{ display: 'flex', justifyContent: 'right', alignItems: 'center' }}>
            ...
            <Typography
                style={{ fontSize: '14px', fontFamily: 'Roboto,sans-serif', color: '#fff', cursor: 'pointer' }}
                onClick={() => handleClick('/')}
              >
                Home
              </Typography>
              <Typography
                style={{marginLeft: '15px', fontSize: '14px', fontFamily: 'Roboto,sans-serif', color: '#fff', cursor: 'pointer' }}
